...
/** @type {string} */
const CACHE_VERSION = '1784845268|20347636901';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["sling-king.html","sling-king.js","sling-king.offline.html","sling-king.icon.png","sling-king.apple-touch-icon.png","sling-king.audio.worklet.js","sling-king.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["sling-king.wasm","sling-king.pck"];
